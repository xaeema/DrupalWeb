...
namespace Drupal\Tests\ebt_webform\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_webform'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_webform']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_webform');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_webform'));
